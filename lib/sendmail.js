...
//  }
	...
	var transport, host, port, auth, from, protocol, sysopts,
	 domain, secure;
...
//  	sysopts = { host: host, port:port, name: domain, secureConnection: secure, auth: auth };
  	
	sysopts = { host: host, port:port, name: domain, secure: secure, auth: auth };
